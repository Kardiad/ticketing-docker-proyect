...
@Component
public class SecurityFilterSecure extends OncePerRequestFilter {
    private final JwtInternalService jwtService;

    public SecurityFilterSecure(JwtInternalService jwtService) {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (header != null && header.startsWith("Bearer ")) {
            ...
            try {
                var claimsJws = jwtService.validateToken(token);
